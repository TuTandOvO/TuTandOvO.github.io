...
.omx{--you:#d05a4f;--bro:#3b73c4;--grn:#2f9e6e;--vio:#7a55c4;--amb:#c79a3a;
  --txt:var(--global-text-color);--mut:var(--global-text-color-light);
  --card:var(--global-card-bg-color);--ln:var(--global-divider-color);
  --tint:#f6f2ea;--track:#ece6db;--ok:#eaf5ee;color:var(--txt)}
html[data-theme=dark] .omx{--tint:#23252e;--track:#2c2e38;--ok:#16251d}
.omx h2,.omx h3{font-family:"Fraunces",serif;font-weight:600;color:var(--txt)}
.omx .lead{font-size:15px;line-height:1.6;color:var(--txt)}
...
.omx-step::before{content:"";position:absolute;left:18px;top:8px;bottom:-4px;width:2px;background:linear-gradient(#e0a39b,var(--ln))}
...
.omx-step p{font-size:14.5px;line-height:1.62;color:var(--txt);margin:.45rem 0}
...
.omx-fig{border:1px solid var(--ln);border-radius:14px;background:var(--card);padding:14px;margin:.8rem 0}
...
.omx-anc .col{border:1px solid var(--ln);border-radius:14px;padding:14px 10px;text-align:center;background:var(--card)}
.omx-anc .ttl{font-weight:600;font-size:13px;color:var(--txt)}
...
.omx-anc .ok{background:var(--ok)}
.omx-cites{display:flex;flex-wrap:wrap;gap:7px;margin:.7rem 0 .2rem}
.omx-cites a,.omx-cites span{font-family:"IBM Plex Mono",monospace;font-size:10.5px;color:var(--txt);background:var(--tint);
...
.omx-model{border:1px solid var(--ln);border-radius:14px;padding:14px;background:var(--card)}
.omx-model .h{font-weight:600;font-size:13px;display:flex;align-items:center;gap:9px;color:var(--txt)}
...
.omx-scale{position:relative;height:18px;border-radius:9px;margin:40px 0 10px;
  background:linear-gradient(90deg,#dfe6ef,#bcd3f0 28%,#f3c4bd 55%,#e8d6ae);border:1px solid var(--ln)}
...
.omx-tile{border:1px solid var(--ln);border-radius:11px;padding:11px 12px;background:var(--tint)}
.omx-tile .v{font-family:"Fraunces",serif;font-weight:600;font-size:26px;line-height:1;color:var(--txt)}
...
.omx-prs .bar{position:relative;height:36px;background:var(--track);border-radius:7px;overflow:hidden}
...
.omx-loci{width:100%;border-collapse:collapse;font-size:12.5px;margin:.4rem 0;color:var(--txt)}
...
.omx-loci td{padding:7px 8px;border-bottom:1px solid var(--ln)}
...
.omx-pill.b{background:#cfe0f5;color:#23507f}.omx-pill.s{background:#dde1e7;color:#5a626d}
.omx-concl{background:#0f1216;color:#fff;border:1px solid var(--ln);border-radius:16px;padding:22px 24px;margin:1rem 0}
.omx-concl h3{color:#fff;font-size:20px;margin:0 0 8px}
.omx-concl p{color:#fff;font-size:15px;line-height:1.66;margin:0}
.omx-concl em{color:#f3a39b;font-style:normal;font-weight:600}
.omx-dia text.lab{fill:#8a93a0}
@media(max-width:620px){.omx-anc,.omx-models{grid-template-columns:1fr}.omx-tiles{grid-template-columns:repeat(2,1fr)}}
</style>

<div class="omx">

<blockquote style="border-left:3px solid #e2c3bf; margin:1rem 0; padding:.3rem 0 .3rem 1rem; color:var(--global-text-color-light); font-size:14px"><b>A personal-genomics side project</b> — and an exercise in honest reasoning. <b>n = 2</b>, exploratory, hypothesis-generating. No causal claim is made or implied.</blockquote>
...
<div class="omx-step">
  ...
  <div style="display:flex;align-items:center;gap:16px;flex-wrap:wrap;margin:.7rem 0 .2rem">
    <svg width="30" height="42" viewBox="0 0 30 42" fill="none"><g stroke="#8a93a0" stroke-width="1.7" stroke-linecap="round"><path d="M9 5c0 6.5 12 6.5 12 13s-12 6.5-12 13"/><path d="M21 5c0 6.5-12 6.5-12 13s12 6.5 12 13"/><path d="M11 9.5h8M10 15h10M10 23h10M11 28.5h8"/></g></svg>
...
<div class="omx-step">
  ...
  <div class="omx-fig">
    <svg viewBox="0 0 372 100" style="width:100%;max-width:500px;display:block;margin:2px auto">
      <text x="6" y="13" font-size="11" fill="#8a93a0" font-family="monospace">read stack at one position</text>
      <g transform="translate(6,20)">
        ...
        <rect x="47" y="-3" width="17" height="75" fill="none" stroke="#d05a4f" stroke-width="2" rx="2"/>
      </g>
      ...
      <text x="156" y="90" font-size="10" fill="#8a93a0" font-family="monospace">small CNN</text>
      ...
      <text x="304" y="52" font-size="10" fill="#8a93a0">fast ·</text><text x="304" y="64" font-size="10" fill="#8a93a0">most sites</text>
    </svg>
  ...
  <div class="omx-fig">
    <svg viewBox="0 0 372 100" style="width:100%;max-width:500px;display:block;margin:2px auto">
      <text x="6" y="13" font-size="11" fill="#8a93a0" font-family="monospace">full local alignment window (gray = indel gap)</text>
      <g transform="translate(6,20)">
      ...
      <text x="148" y="90" font-size="10" fill="#8a93a0" font-family="monospace">deeper CNN</text>
      ...
      <text x="306" y="52" font-size="10" fill="#8a93a0">hard ·</text><text x="306" y="64" font-size="10" fill="#8a93a0">indels</text>
    </svg>
...
<div class="omx-step">
  ...
  <div class="omx-fig">
    <svg viewBox="0 0 372 96" style="width:100%;max-width:500px;display:block;margin:2px auto">
      <text x="6" y="12" font-size="10" fill="#8a93a0" font-family="monospace">per-sample gVCFs</text>
      <text x="10" y="26" font-size="9" fill="#8a93a0" font-family="monospace">me</text>
      <g transform="translate(8,30)"><rect x="0" y="0" width="20" height="9" rx="2" fill="#2f9e6e"/><rect x="0" y="11" width="20" height="9" rx="2" fill="#e6e3da"/><rect x="0" y="22" width="20" height="9" rx="2" fill="#3b73c4"/><rect x="0" y="33" width="20" height="9" rx="2" fill="#e6e3da"/><rect x="0" y="44" width="20" height="9" rx="2" fill="#d05a4f"/></g>
      <text x="36" y="26" font-size="9" fill="#8a93a0" font-family="monospace">bro</text>
      <g transform="translate(34,30)"><rect x="0" y="0" width="20" height="9" rx="2" fill="#2f9e6e"/><rect x="0" y="11" width="20" height="9" rx="2" fill="#c79a3a"/><rect x="0" y="22" width="20" height="9" rx="2" fill="#3b73c4"/><rect x="0" y="33" width="20" height="9" rx="2" fill="#e6e3da"/><rect x="0" y="44" width="20" height="9" rx="2" fill="#d05a4f"/></g>
      <path d="M62 50 h26" stroke="#aaa" stroke-width="2"/>
      <path d="M94 30 h40 l-13 15 v13 l-14 5 v-18 z" fill="none" stroke="#7a55c4" stroke-width="2" stroke-linejoin="round"/>
      <text x="96" y="74" font-size="9" fill="#8a93a0" font-family="monospace">GLnexus</text>
      <path d="M142 50 h22" stroke="#aaa" stroke-width="2"/>
      <text x="174" y="24" font-size="9" fill="#8a93a0" font-family="monospace">joint VCF · 2 samples</text>
      <g transform="translate(176,30)">
        <rect x="0" y="0" width="20" height="9" rx="2" fill="#2f9e6e"/><rect x="22" y="0" width="20" height="9" rx="2" fill="#2f9e6e"/>
        <rect x="0" y="11" width="20" height="9" rx="2" fill="#e6e3da"/><rect x="22" y="11" width="20" height="9" rx="2" fill="#c79a3a"/>
        <rect x="0" y="22" width="20" height="9" rx="2" fill="#3b73c4"/><rect x="22" y="22" width="20" height="9" rx="2" fill="#3b73c4"/>
        <rect x="0" y="33" width="20" height="9" rx="2" fill="#e6e3da"/><rect x="22" y="33" width="20" height="9" rx="2" fill="#e6e3da"/>
        <rect x="0" y="44" width="20" height="9" rx="2" fill="#d05a4f"/><rect x="22" y="44" width="20" height="9" rx="2" fill="#d05a4f"/>
        <rect x="-3" y="-3" width="48" height="59" fill="none" stroke="#bbb" stroke-width="1" rx="3"/>
      </g>
    </svg>
    <div class="omx-cap"><b>Joint genotyping.</b> Two per-sample gVCFs are merged into one harmonized 2-sample matrix, so every site is judged the same way for both of us.</div>
  </div>
...
<div class="omx-step">
  ...
  <div class="omx-fig">
    <svg viewBox="0 0 372 84" style="width:100%;max-width:500px;display:block;margin:2px auto">
      <text x="6" y="12" fill="#8a93a0" font-size="10" font-family="monospace">one variant</text>
      <rect x="6" y="20" width="96" height="24" rx="5" fill="none" stroke="#3b73c4" stroke-width="1.6"/>
      <text x="14" y="36" fill="#3b73c4" font-size="10.5" font-family="monospace">chr4:451k A&gt;G</text>
      <path d="M108 32 h20" stroke="#aaa" stroke-width="2"/>
      <text x="132" y="13" fill="#8a93a0" font-size="9" font-family="monospace">VEP adds</text>
      <g font-family="monospace" font-size="8.5">
        <rect x="132" y="18" width="74" height="15" rx="7.5" fill="#eef6f0" stroke="#2f9e6e"/><text x="139" y="28.5" fill="#2f9e6e">gene · GNPDA2</text>
        <rect x="212" y="18" width="58" height="15" rx="7.5" fill="#f2ecfb" stroke="#7a55c4"/><text x="219" y="28.5" fill="#7a55c4">missense</text>
        <rect x="132" y="37" width="58" height="15" rx="7.5" fill="#e9f1fb" stroke="#3b73c4"/><text x="139" y="47.5" fill="#3b73c4">gnomAD AF</text>
        <rect x="196" y="37" width="78" height="15" rx="7.5" fill="#fdeceb" stroke="#d05a4f"/><text x="203" y="47.5" fill="#d05a4f">SIFT/PolyPhen</text>
      </g>
    </svg>
    <div class="omx-cap"><b>Annotation.</b> A bare variant gains its gene, consequence, population frequency (gnomAD), and pathogenicity predictions — turning coordinates into biology.</div>
  </div>
  ...
  <div class="omx-fig">
    <svg viewBox="0 0 372 96" style="width:100%;max-width:500px;display:block;margin:2px auto">
      <text x="6" y="12" fill="#8a93a0" font-size="10" font-family="monospace">thousands of variants × weights</text>
      <g transform="translate(8,20)">
        <circle cx="4" cy="5" r="3" fill="#3b73c4"/><rect x="12" y="2" width="34" height="6" rx="3" fill="#d05a4f"/>
        <circle cx="4" cy="17" r="3" fill="#2f9e6e"/><rect x="12" y="14" width="20" height="6" rx="3" fill="#d05a4f" opacity=".7"/>
        <circle cx="4" cy="29" r="3" fill="#c79a3a"/><rect x="12" y="26" width="46" height="6" rx="3" fill="#d05a4f"/>
        <circle cx="4" cy="41" r="3" fill="#7a55c4"/><rect x="12" y="38" width="16" height="6" rx="3" fill="#3b73c4" opacity=".7"/>
        <circle cx="4" cy="53" r="3" fill="#3b73c4"/><rect x="12" y="50" width="30" height="6" rx="3" fill="#d05a4f"/>
        <text x="2" y="70" fill="#8a93a0" font-size="11">&#8942;</text>
      </g>
      <path d="M70 44 h18" stroke="#aaa" stroke-width="2"/>
      <text x="92" y="54" font-size="30" fill="#7a55c4" font-family="Georgia,serif">&#931;</text>
      <path d="M122 44 h18" stroke="#aaa" stroke-width="2"/>
      <rect x="146" y="31" width="74" height="26" rx="6" fill="none" stroke="#d05a4f" stroke-width="1.6"/>
      <text x="183" y="48" fill="#d05a4f" font-size="12" text-anchor="middle" font-family="monospace" font-weight="600">PGS</text>
      <text x="146" y="74" fill="#8a93a0" font-size="9" font-family="monospace">one weighted score per person</text>
    </svg>
    <div class="omx-cap"><b>Polygenic score.</b> Each variant nudges the score up or down by its published weight; summed across the genome, they give one BMI-predisposition number per person.</div>
  </div>
  <div class="omx-prs">
